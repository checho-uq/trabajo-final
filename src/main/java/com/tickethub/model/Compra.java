...
import com.tickethub.model.state.CompraCreada;
import com.tickethub.model.state.CompraIncidencia;
import com.tickethub.model.state.IEstadoCompra;
...
public class Compra {
    ...
    public void reportarIncidencia() {
        this.estadoActual = new CompraIncidencia();
        System.out.println("Compra " + idCompra + " -> INCIDENCIA");
    }
